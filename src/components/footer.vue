      ...
      <div class="container">
        <div class="row mb-5">
          <div class="col-md">
            <div class="ftco-footer-widget mb-4">
              <h2 class="ftco-heading-2 logo">Claire Beauty Lounge</h2>
          ...
          <div class="col-md">
            <div class="ftco-footer-widget mb-4">
            	...
            	<div class="block-23 mb-3">
                	              <ul>
	                <li><span class="icon icon-map-marker"></span><span class="text">890,Sector 62, Gyan Sarovar, GAIL Noida(Delhi/NCR)</span></li>
	                <li><a href="#"><span class="icon icon-phone"></span><span class="text">+7896541236</span></a></li>
        ...
        <div class="row">
          <div class="col-md-12 text-center">
            ...
            <p>
  2023 © Claire Beauty Lounge SJDM </p>
          </div>
        </div>
      </div>
    </footer>
