...
const paginate = (page) => {
    appointmentData.getStatusgappointments(page, 3,dateRange.value, searchData.value);
}

onBeforeMount(() => {
 appointmentData.getStatusgappointments(1,3);
});
...
watch(selectedOption, (newValue, oldValue) => {
  ...
  appointmentData.getStatusgappointments(1, 3,dateRange.value, searchData.value);
});

const SearchFilter = (searchQuery) => {
  appointmentData.getStatusgappointments(1,3,dateRange.value,searchQuery);
};
